        ...
        public void Run()
        {
            ...
            while (input[0] != "Exit")
            {
                ...
                try
                {
                    ...
                    else if (commandName == "FeedFish")
                    {
                        string aquariumName = input[1];

                        result = controller.FeedFish(aquariumName);
                    }
                    else if (commandName == "CalculateValue")
                    {
                        string aquariumName = input[1];
